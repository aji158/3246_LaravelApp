...
class MidtransWebhookController extends Controller
{
    public function handle(Request $request)
    {
        ...
        if ($transactionStatus == 'capture') {
            ...
            $transaction->status = 'success'; // Kita ubah langsung menjadi success untuk kemudahan status lokal
            $this->processSuccess($transaction);
   ...
   private function processSuccess(Transaction $transaction)
    ...
    } // <-- INI UNTUK MENUTUP FUNCTION processSuccess

} // <-- INI UNTUK MENUTUP CLASS MidtransWebhookController (Tambahkan ini jika belum ada!)